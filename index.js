...
conn.sendMessage(id, ' _🤖BOT MENGUCAPKAN TERIMAKASIH🤖💌UNTUK BUAT BOT TOTON CHANEL Fyrus :https://youtu.be/affmdx7mskM👈' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾XONTOL BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/IndraFajri64' ,MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾XONTOL BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/IndraFajri64' ,MessageType.text);
}
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾XONTOL BOT👾* , Follow Instagram Mimin Yah😻 :https://youtu.be/affmdx7mskM' ,MessageType.text);
}
